...
import 'package:sporify/presentation/spotify/bloc/spotify_popular_artists_cubit.dart';
...
class SpotifyArtistList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => SpotifyPopularArtistsCubit()..getPopularArtists(),
      child:
          BlocBuilder<SpotifyPopularArtistsCubit, SpotifyPopularArtistsState>(
            builder: (context, state) {
              if (state is SpotifyPopularArtistsLoading) {
                return Container(
              ...
              if (state is SpotifyPopularArtistsError) {
                return Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () => context
                              .read<SpotifyPopularArtistsCubit>()
                              .getPopularArtists(),
                          child: const Text(
                            "Retry",
